...
<style scoped>
    ...
    .personnel__text_left {
        position: absolute;
        height: 35px;
        left: 0%;
        right: 68.85%;
        top: calc(50% - 35px/2 - 0.67px);
